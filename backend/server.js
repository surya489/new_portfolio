...
app.use(cors({
    origin: 'jayasurya-portfolio-new.vercel.app',
    methods: ['GET', 'POST'],
    credentials: true
}));
        ...
        const mailOptionsClient = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
                    ...
                    <p style="font-size: 16px; color: #333;">I will get back to you shortly to discuss further. Meanwhile, feel free to check out some of my latest projects on my <a href="jayasurya-portfolio-new.vercel.app" style="color: #4CAF50; text-decoration: none;">portfolio website</a>.</p>
